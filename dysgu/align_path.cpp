...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "dysgu.align_path",
        "sources": [
            "dysgu/align_path.pyx"
        ]
    },
    "module_name": "dysgu.align_path"
}
END: Cython Metadata */
...
#define __PYX_HAVE__dysgu__align_path
#define __PYX_HAVE_API__dysgu__align_path
/* Early includes */
#include <string.h>
#include <stdio.h>
#include "pythread.h"
 ...
 * 
 */
typedef __pyx_t_5numpy_float_t __pyx_t_5dysgu_10align_path_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'dysgu.align_path' */
static float __pyx_f_5dysgu_10align_path_erfcc(float); /*proto*/
static float __pyx_f_5dysgu_10align_path_normcdf(float, float, float); /*proto*/
static int __pyx_f_5dysgu_10align_path_is_proper_pair(float, float, float, float, float, float, float); /*proto*/
static float __pyx_f_5dysgu_10align_path_bwa_pair_score(float, float, float, float, float); /*proto*/
static PyObject *__pyx_convert_vector_to_py_int(const std::vector<int>  &); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5dysgu_10align_path_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_5dysgu_10align_path_DTYPE_t), { 0 }, 0, 'R', 0, 0 };
...
#define __Pyx_MODULE_NAME "dysgu.align_path"
extern int __pyx_module_is_main_dysgu__align_path;
int __pyx_module_is_main_dysgu__align_path = 0;

/* Implementation of 'dysgu.align_path' */
...
static const char __pyx_k_dysgu_align_path[] = "dysgu.align_path";
...
static const char __pyx_k_dysgu_align_path_pyx[] = "dysgu/align_path.pyx";
...
static PyObject *__pyx_n_s_dtype;
static PyObject *__pyx_n_s_dysgu_align_path;
static PyObject *__pyx_kp_s_dysgu_align_path_pyx;
...
static float __pyx_f_5dysgu_10align_path_erfcc(float __pyx_v_x) {
  float __pyx_v_z;
  float __pyx_v_t;
  float __pyx_v_r;
  float __pyx_v_p1;
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("dysgu.align_path.erfcc", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "dysgu/align_path.pyx":44
 * 
 * 
...
static float __pyx_f_5dysgu_10align_path_normcdf(float __pyx_v_x, float __pyx_v_mu, float __pyx_v_sigma) {
  float __pyx_v_t;
  float __pyx_v_y;
  float __pyx_r;
  float __pyx_t_1;
 ...
 */
  ...
  __pyx_v_y = (0.5 * __pyx_f_5dysgu_10align_path_erfcc((__pyx_t_1 / __pyx_t_2)));

  /* "dysgu/align_path.pyx":48
 *     t = x-mu
 *     y = 0.5*erfcc(-t/(sigma*sqrt(2.0)))
 *     if y > 1.0:             # <<<<<<<<<<<<<<
 *         y = 1.0
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("dysgu.align_path.normcdf", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "dysgu/align_path.pyx":53
 * 
 * 
...
static int __pyx_f_5dysgu_10align_path_is_proper_pair(float __pyx_v_d, float __pyx_v_pos1, float __pyx_v_pos2, float __pyx_v_strand1, float __pyx_v_strand2, float __pyx_v_mu, float __pyx_v_sigma) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;

  /* "dysgu/align_path.pyx":55
 * cdef int is_proper_pair(float d, float pos1, float pos2, float strand1, float strand2, float mu, float sigma) nogil:
 * 
 *     if d <= (mu + 4*sigma):             # <<<<<<<<<<<<<<
...
static float __pyx_f_5dysgu_10align_path_bwa_pair_score(float __pyx_v_d, float __pyx_v_mu, float __pyx_v_sigma, float __pyx_v_match_score, float __pyx_v_u) {
  float __pyx_v_prob;
  float __pyx_v_c;
  float __pyx_r;
  double __pyx_t_1;
 ...
 *     if c < u:
 */
  __pyx_v_prob = (1.0 - __pyx_f_5dysgu_10align_path_normcdf(__pyx_v_d, __pyx_v_mu, __pyx_v_sigma));

  /* "dysgu/align_path.pyx":75
 *     cdef float prob, c
 *     prob = (1 - normcdf(d, mu, sigma))
 *     c = -match_score * (log(prob)/log(4))             # <<<<<<<<<<<<<<
 *     if c < u:
 ...
 */
  ...
  /* function exit code */
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("dysgu.align_path.bwa_pair_score", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_r = 0;
  __pyx_L0:;
  return __pyx_r;
}

/* "dysgu/align_path.pyx":82
 * 
 * 
 * def optimal_path(             # <<<<<<<<<<<<<<
...
static PyObject *__pyx_pw_5dysgu_10align_path_1optimal_path(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("dysgu.align_path.optimal_path", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_5dysgu_10align_path_optimal_path(__pyx_self, __pyx_v_segments, __pyx_v_contig_length, __pyx_v_mu, __pyx_v_sigma, __pyx_v_max_insertion, __pyx_v_min_aln, __pyx_v_max_homology, __pyx_v_ins_cost, __pyx_v_hom_cost, __pyx_v_inter_cost, __pyx_v_U, __pyx_v_match_score, __pyx_v_clipping_penalty);
...
static PyObject *__pyx_pf_5dysgu_10align_path_optimal_path(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_segments, float __pyx_v_contig_length, float __pyx_v_mu, float __pyx_v_sigma, float __pyx_v_max_insertion, float __pyx_v_min_aln, float __pyx_v_max_homology, float __pyx_v_ins_cost, float __pyx_v_hom_cost, float __pyx_v_inter_cost, float __pyx_v_U, float __pyx_v_match_score, CYTHON_UNUSED float __pyx_v_clipping_penalty) {
  ...
  __pyx_pybuffernd_segments.rcbuffer = &__pyx_pybuffer_segments;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_segments.rcbuffer->pybuffer, (PyObject*)__pyx_v_segments, &__Pyx_TypeInfo_nn___pyx_t_5dysgu_10align_path_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 82, __pyx_L1_error)
  }
 ...
 */
    ...
    *__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float_t *, __pyx_pybuffernd_node_scores.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_node_scores.diminfo[0].strides) = ((*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_12, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_13, __pyx_pybuffernd_segments.diminfo[1].strides)) - ((*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_14, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_15, __pyx_pybuffernd_segments.diminfo[1].strides)) * __pyx_v_ins_cost));
  }

  /* "dysgu/align_path.pyx":139
 ...
 */
    ...
    __pyx_t_18 = 0;
    __pyx_v_chr1 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_18, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dysgu/align_path.pyx":150
 *     for i in range(1, segments.shape[0]):
 *         chr1 = segments[i, 0]
 *         pos1 = segments[i, 1]             # <<<<<<<<<<<<<<
 *         start1 = segments[i, 2]
 ...
 */
    ...
    __pyx_t_20 = 1;
    __pyx_v_pos1 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_19, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_20, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dysgu/align_path.pyx":151
 *         chr1 = segments[i, 0]
 *         pos1 = segments[i, 1]
 *         start1 = segments[i, 2]             # <<<<<<<<<<<<<<
 *         end1 = segments[i, 3]
 ...
 */
    ...
    __pyx_t_22 = 2;
    __pyx_v_start1 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dysgu/align_path.pyx":152
 *         pos1 = segments[i, 1]
 *         start1 = segments[i, 2]
 *         end1 = segments[i, 3]             # <<<<<<<<<<<<<<
 *         score1 = segments[i, 4]
 ...
 */
    ...
    __pyx_t_24 = 3;
    __pyx_v_end1 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_24, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dysgu/align_path.pyx":153
 *         start1 = segments[i, 2]
 *         end1 = segments[i, 3]
 *         score1 = segments[i, 4]             # <<<<<<<<<<<<<<
 *         row_index1 = segments[i, 5]
 ...
 */
    ...
    __pyx_t_26 = 4;
    __pyx_v_score1 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_26, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dysgu/align_path.pyx":154
 *         end1 = segments[i, 3]
 *         score1 = segments[i, 4]
 *         row_index1 = segments[i, 5]             # <<<<<<<<<<<<<<
 *         strand1 = segments[i, 6]
 ...
 */
    ...
    __pyx_t_28 = 5;
    __pyx_v_row_index1 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_28, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dysgu/align_path.pyx":155
 *         score1 = segments[i, 4]
 *         row_index1 = segments[i, 5]
 *         strand1 = segments[i, 6]             # <<<<<<<<<<<<<<
 *         r1 = segments[i, 7]
 ...
 */
    ...
    __pyx_t_30 = 6;
    __pyx_v_strand1 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_30, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dysgu/align_path.pyx":156
 *         row_index1 = segments[i, 5]
 *         strand1 = segments[i, 6]
 *         r1 = segments[i, 7]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __pyx_t_32 = 7;
    __pyx_v_r1 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_31, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_32, __pyx_pybuffernd_segments.diminfo[1].strides));

    /* "dysgu/align_path.pyx":158
 *         r1 = segments[i, 7]
 * 
 *         p = -1  # -1 means there is no presecessor             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_35 = 0;
      __pyx_v_chr2 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_34, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_35, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dysgu/align_path.pyx":166
 * 
 *             chr2 = segments[j, 0]
 *             pos2 = segments[j, 1]             # <<<<<<<<<<<<<<
 *             start2 = segments[j, 2]
 ...
 */
      ...
      __pyx_t_37 = 1;
      __pyx_v_pos2 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_36, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_37, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dysgu/align_path.pyx":167
 *             chr2 = segments[j, 0]
 *             pos2 = segments[j, 1]
 *             start2 = segments[j, 2]             # <<<<<<<<<<<<<<
 *             end2 = segments[j, 3]
 ...
 */
      ...
      __pyx_t_39 = 2;
      __pyx_v_start2 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_38, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_39, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dysgu/align_path.pyx":168
 *             pos2 = segments[j, 1]
 *             start2 = segments[j, 2]
 *             end2 = segments[j, 3]             # <<<<<<<<<<<<<<
 *             score2 = segments[j, 4]
 ...
 */
      ...
      __pyx_t_41 = 3;
      __pyx_v_end2 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_40, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_41, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dysgu/align_path.pyx":169
 *             start2 = segments[j, 2]
 *             end2 = segments[j, 3]
 *             score2 = segments[j, 4]             # <<<<<<<<<<<<<<
 *             row_index2 = segments[j, 5]
 ...
 */
      ...
      __pyx_t_43 = 4;
      __pyx_v_score2 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_42, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_43, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dysgu/align_path.pyx":170
 *             end2 = segments[j, 3]
 *             score2 = segments[j, 4]
 *             row_index2 = segments[j, 5]             # <<<<<<<<<<<<<<
 *             strand2 = segments[j, 6]
 ...
 */
      ...
      __pyx_t_45 = 5;
      __pyx_v_row_index2 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_44, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_45, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dysgu/align_path.pyx":171
 *             score2 = segments[j, 4]
 *             row_index2 = segments[j, 5]
 *             strand2 = segments[j, 6]             # <<<<<<<<<<<<<<
 *             r2 = segments[j, 7]
 ...
 */
      ...
      __pyx_t_47 = 6;
      __pyx_v_strand2 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_46, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_47, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dysgu/align_path.pyx":172
 *             row_index2 = segments[j, 5]
 *             strand2 = segments[j, 6]
 *             r2 = segments[j, 7]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_49 = 7;
      __pyx_v_r2 = (*__Pyx_BufPtrStrided2d(__pyx_t_5dysgu_10align_path_DTYPE_t *, __pyx_pybuffernd_segments.rcbuffer->pybuffer.buf, __pyx_t_48, __pyx_pybuffernd_segments.diminfo[0].strides, __pyx_t_49, __pyx_pybuffernd_segments.diminfo[1].strides));

      /* "dysgu/align_path.pyx":175
 * 
 *             # Allow alignments with minimum sequence and max overlap
 ...
 */
            __pyx_v_proper_pair = __pyx_f_5dysgu_10align_path_is_proper_pair(__pyx_v_distance, __pyx_v_pos1, __pyx_v_pos2, __pyx_v_strand1, __pyx_v_strand2, __pyx_v_mu, __pyx_v_sigma);

            /* "dysgu/align_path.pyx":198
 *                         distance = fabs(pos1 - pos2)
 *                         proper_pair = is_proper_pair(distance, pos1, pos2, strand1, strand2, mu, sigma)
 *                         if proper_pair:             # <<<<<<<<<<<<<<
 *                             jump_cost = bwa_pair_score(distance, mu, sigma, match_score, U)
 ...
 *                         else:
 */
              __pyx_v_jump_cost = __pyx_f_5dysgu_10align_path_bwa_pair_score(__pyx_v_distance, __pyx_v_mu, __pyx_v_sigma, __pyx_v_match_score, __pyx_v_U);

              /* "dysgu/align_path.pyx":200
 *                         if proper_pair:
 *                             jump_cost = bwa_pair_score(distance, mu, sigma, match_score, U)
 *                             normal_jumps.add((i, j))  # Keep track of normal pairings on the path             # <<<<<<<<<<<<<<
 *                         else:
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_65 = PyTuple_New(5); if (unlikely(!__pyx_t_65)) __PYX_ERR(0, 300, __pyx_L1_error)
...
static int __pyx_pymod_exec_align_path(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_align_path},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_dtype, __pyx_k_dtype, sizeof(__pyx_k_dtype), 0, 0, 1, 1},
  {&__pyx_n_s_dysgu_align_path, __pyx_k_dysgu_align_path, sizeof(__pyx_k_dysgu_align_path), 0, 0, 1, 1},
  {&__pyx_kp_s_dysgu_align_path_pyx, __pyx_k_dysgu_align_path_pyx, sizeof(__pyx_k_dysgu_align_path_pyx), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__9 = (PyObject*)__Pyx_PyCode_New(13, 0, 64, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__8, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_dysgu_align_path_pyx, __pyx_n_s_optimal_path, 82, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__9)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initalign_path(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initalign_path(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_align_path(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_align_path(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_align_path(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'align_path' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_align_path(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("align_path", __pyx_methods, __pyx_k_http_stackoverflow_com_question, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_dysgu__align_path) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "dysgu.align_path")) {
      if (unlikely(PyDict_SetItemString(modules, "dysgu.align_path", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *                  float contig_length,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_5dysgu_10align_path_1optimal_path, NULL, __pyx_n_s_dysgu_align_path); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_optimal_path, __pyx_t_2) < 0) __PYX_ERR(0, 82, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "dysgu/align_path.pyx":1
 * #!python             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init dysgu.align_path", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dysgu.align_path");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
