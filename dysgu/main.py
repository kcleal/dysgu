...
@click.option("--low-mem", help="In single thread mode -p1, use less memory but more temp disk space", is_flag=True, flag_value=True, show_default=False, default=False)
